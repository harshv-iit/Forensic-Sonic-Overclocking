...
* **Hardware-Matched SPL Calibration:** Translates digital full-scale levels (0 dBFS) to physical Sound Pressure Level (dB SPL) based on real-world output limits (calibrated to a ~0.6Vrms hardware limit and 116dB/Vrms transducer sensitivity).
